...
# ---------------------------------------------------------
# FILE PATHS — use GPKG for roads
# ---------------------------------------------------------
cut_roads_files = {
    "10 yr": f"{output_dir}/cut_roads_flood_risk_10.gpkg",
    "100 yr": f"{output_dir}/cut_roads_flood_risk_100.gpkg",
    "500 yr": f"{output_dir}/cut_roads_flood_risk_500.gpkg",
    "DANA_31_10_2024": f"{output_dir}/cut_roads_DANA_31_10_2024.gpkg",
    "DANA_03_11_2024": f"{output_dir}/cut_roads_DANA_03_11_2024.gpkg",
    "DANA_05_11_2024": f"{output_dir}/cut_roads_DANA_05_11_2024.gpkg",
    "DANA_06_11_2024": f"{output_dir}/cut_roads_DANA_06_11_2024.gpkg",
    "DANA_08_11_2024": f"{output_dir}/cut_roads_DANA_08_11_2024.gpkg"
}

safe_roads_files = {
    "10 yr": f"{output_dir}/safe_roads_flood_risk_10.gpkg",
    "100 yr": f"{output_dir}/safe_roads_flood_risk_100.gpkg",
    "500 yr": f"{output_dir}/safe_roads_flood_risk_500.gpkg",
    "DANA_31_10_2024": f"{output_dir}/safe_roads_DANA_31_10_2024.gpkg",
    "DANA_03_11_2024": f"{output_dir}/safe_roads_DANA_03_11_2024.gpkg",
    "DANA_05_11_2024": f"{output_dir}/safe_roads_DANA_05_11_2024.gpkg",
    "DANA_06_11_2024": f"{output_dir}/safe_roads_DANA_06_11_2024.gpkg",
    "DANA_08_11_2024": f"{output_dir}/safe_roads_DANA_08_11_2024.gpkg"
}
...
for name, gdf in flood_zones_var.items():
    ...
    # --- Save figure ---
    save_path = f"{results_dir}/map_{name.replace(' ', '_')}.png"
